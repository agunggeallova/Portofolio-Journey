...
export default function Navbar() {
  ...
  // Market and Scanner now live inside the Lab section rather than sitting
  // in the nav as if they were biography chapters.
  const links = [
    ...
    <div className="shell">
      ...
      >
        <a className="font-serif font-bold text-lg tracking-tight" href="#top">
          0x<span className="text-lime">BAGAS</span>
        ...
        <div className="flex items-center gap-2 lg:gap-5">
          ...
          >
            ...
            >
              <i
                aria-hidden="true"
                className="w-1.5 h-1.5 rounded-full bg-lime mr-2 pulse-dot shadow-[0_0_9px_var(--lime)]"
              />
              {t.availability}
            </a>
          </div>
