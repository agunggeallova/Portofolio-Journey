  ...
  en: {
    ...
    about: {
      ...
      panels: [
        ...
        },
        {
          ...
          body: [
            ...
            "Outside Web3 I run businesses of my own: June Grafika in printing and custom packaging, and Gayain Nusantara, a travel platform I built end to end.",
          ],
        },
        {
          icon: "tech",
      ...
      stats: [
        ...
        { value: "8", label: "Projects Contributed To" },
      ],
    },
    ...
    work: {
      ...
      projects: [
        ...
        },
        {
          slug: "ventures",
          name: "VENTURES",
          category: "DIGITAL BUSINESS · WEB · BEYOND WEB3",
          description:
            "Two businesses of my own: June Grafika in printing and custom packaging, and Gayain Nusantara, a travel platform built end to end.",
          contribution:
            "Branding, marketing and operations for June Grafika; website structure, UI/UX, content and booking flow for Gayain Nusantara.",
          tags: ["Business", "Web Dev", "UI/UX", "Branding"],
      ...
      panels: [
        ...
        },
        {
          ...
          body: [
            ...
            "Di luar Web3 saya menjalankan bisnis sendiri: June Grafika di printing dan custom packaging, serta Gayain Nusantara, platform travel yang saya bangun dari nol.",
          ],
        },
        {
          icon: "tech",
    ...
    work: {
      ...
      projects: [
        ...
        },
        {
          slug: "ventures",
          name: "VENTURES",
          category: "DIGITAL BUSINESS · WEB · DI LUAR WEB3",
          description:
            "Dua bisnis milik saya: June Grafika di printing dan custom packaging, serta Gayain Nusantara, platform travel yang dibangun dari nol.",
          contribution:
            "Branding, marketing, dan operasional untuk June Grafika; struktur website, UI/UX, konten, dan alur booking untuk Gayain Nusantara.",
          tags: ["Bisnis", "Web Dev", "UI/UX", "Branding"],
