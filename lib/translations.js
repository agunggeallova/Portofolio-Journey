  ...
  en: {
    ...
    about: {
      ...
      lead: [
        ...
        "These days I spend most of my time closer to the product itself — exchange product and operations, UI/UX, digital platforms, and the automation around them. I still research the same way I always have, by using the thing before writing about it.",
      ],
      ...
      panels: [
        ...
        },
        {
          ...
          summary: "Web3 product, exchange operations, community, and digital business.",
          body: [
            "Most of my focus sits on Web3 product and exchange operations. At PLUBIT I handle white-label exchange setup, platform and app configuration, UI/UX, feature testing before release, daily deposit and withdrawal monitoring, Broker Panel development, and Market Maker operations.",
      ...
      projects: [
        {
          ...
          description:
            "Managing product development and exchange operations across white-label setup, platform configuration, testing, and daily operations.",
          contribution:
            "White-label exchange setup, UI/UX, app configuration, feature testing, deposit & withdrawal monitoring, Broker Panel development, and Market Maker operations.",
          tags: ["Product", "Operations", "UI/UX", "White Label", "Market Maker"],
          cta: "EXPLORE PROJECT",
          href: "/work/plubit",
        },
        {
  ...
  id: {
    ...
    about: {
      ...
      lead: [
        ...
        "Sekarang waktu saya lebih banyak dekat ke produknya sendiri — produk dan operasional exchange, UI/UX, platform digital, dan automation di sekitarnya. Cara riset saya tetap sama: memakai dulu, baru menulis.",
      ],
      ...
      panels: [
        ...
        },
        {
          ...
          summary: "Produk Web3, operasional exchange, komunitas, dan digital business.",
          body: [
            "Fokus saya sekarang banyak di produk Web3 dan operasional exchange. Di PLUBIT saya menangani setup white-label exchange, konfigurasi platform dan aplikasi, UI/UX, pengujian fitur sebelum rilis, monitoring deposit dan withdrawal harian, pengembangan Broker Panel, serta operasional Market Maker.",
      ...
      projects: [
        {
          ...
          description:
            "Mengelola pengembangan produk dan operasional exchange mulai dari setup white-label, konfigurasi platform, pengujian fitur, hingga operasional harian.",
          contribution:
            "Setup white-label exchange, UI/UX, konfigurasi aplikasi, pengujian fitur, monitoring deposit & withdrawal, pengembangan Broker Panel, serta operasional Market Maker.",
          tags: ["Produk", "Operasional", "UI/UX", "White Label", "Market Maker"],
          cta: "LIHAT PROJECT",
          href: "/work/plubit",
        },
        {
